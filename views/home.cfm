...
<table cellpadding="5" width="98%" align="center">
    <tr>
        <td valign="top">
			...
			<h3>Caching Examples</h3>
			<p>Cache me if you can.</p>
			<ul>
				<li><a href="#event.buildLink("general.example1")#">View Caching</a></li>
				<li><a href="#event.buildLink("general.example2")#">Event Caching</a></li>
				<li><a href="#event.buildLink("general.example3")#">Model Caching</a></li>
				...
				<li><a href="#event.buildLink("general.example6")#">Custom Eviction Policy</a></li>
			</ul>
